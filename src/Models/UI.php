...
class UI implements JsonSerializable
{
     ...
     * @var Dialogs|null $dialogs public property
     */
    public $dialogs;
     ...
     * notifications.
     *
     * <span style="color: blue;">If you set it to browser language the notifications will be
     ...
     * application
     * @var Styling|null $styling public property
     */
    public $styling;
