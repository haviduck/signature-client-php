...
use IdfySignatureLib\Controllers\OAuthAuthorization;
...
class OAuthManager
{
    ...
    {
        $this->oAuthApi = OAuthAuthorization::getInstance();
    }
     ...
     * @return \IdfySignatureLib\Models\OAuthToken
     */
     ...
     * @param  \IdfySignatureLib\Models\OAuthToken $oAuthToken OAuth token
     */
