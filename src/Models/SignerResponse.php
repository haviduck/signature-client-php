...
class SignerResponse implements JsonSerializable
{
     ...
     * signer and mroe.
     * @var DocumentSignature|null $documentSignature public property
     */
    ...
    public function __construct()
    {
        if (16 == func_num_args()) {
            ...
            $this->signerInfo           = func_get_arg(7);
            $this->authentication       = func_get_arg(8);
            $this->extraInfo            = func_get_arg(9);
            $this->ui                   = func_get_arg(10);
            $this->notificationsEnabled = func_get_arg(11);
            $this->tags                 = func_get_arg(12);
            $this->order                = func_get_arg(13);
            $this->required             = func_get_arg(14);
            $this->signUrlExpires       = func_get_arg(15);
        }
    }
