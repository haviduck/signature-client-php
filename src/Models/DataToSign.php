...
class DataToSign implements JsonSerializable
{
     ...
     * (i.e. bankid sdo)
     * @var array|null $signaturePackageFormat public property
     */
    public $signaturePackageFormat;
     ...
     * @param array  $signaturePackageFormat  Initialization value for $this->signaturePackageFormat
     */
    ...
    public function jsonSerialize()
    {
        ...
        $json['signaturePackageFormat']  = $this->signaturePackageFormat;
