...
class RedirectSettings implements JsonSerializable
{
    ...
    /**
     * The domain your website is hosted on
     *
     * <span style="color: red;">Required if you specify iframe on any of the signers</span>)
     * @var string|null $domain public property
     */
    public $domain;

    /**
     * The signer is returned to this url if something goes wrong.
     *
     * <span style="color: red;">Required if you specify redirect on any of the signers </span>
     * @var string|null $error public property
     */
    public $error;

    /**
     * The signer is returned to this url if the signing has been canceled
     *
     * <span style="color: red;">Required if you specify redirect on any of the signers </span>
    ...
    /**
     * The signer is returned to this url after a successfull signing
     *
     * <span style="color: red;">Required if you specify redirect on any of the signers </span>
